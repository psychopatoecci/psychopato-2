...
class PersonasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'apellido1' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'apellido2' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'identificacion' => '51c44fa0-70ef-46a2-8d70-a373479769df',
            'nombre' => 'Lorem ipsum dolor sit amet',
            'apellido1' => 'Lorem ipsum dolor sit amet',
            'apellido2' => 'Lorem ipsum dolor sit amet',
            'fecha_nacimiento' => '2016-10-11'
        ],
    ];
}
