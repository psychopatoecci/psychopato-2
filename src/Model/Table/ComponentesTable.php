 ...
 * @method \App\Model\Entity\Componente findOrCreate($search, callable $callback = null)
 */
class ComponentesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('nombreComponente', 'create')
            ->notEmpty('nombreComponente');
