							...
							<div class="signup-form">
								<form action="#">
									<div class='col-sm-4'>
										...
										<h3>Medio de pago 1:</h4><br>
										
										<h4>Nombre en la tarjeta:</h4>
										<?php echo "<input type='text' name='tarjetaNombre1' placeholder='Nombre en la tarjeta'
										value = '".$tarjetaNombre1."'>";?>
										<h4>Número de tarjeta:</h4>
										<?php echo "<input type='text' name='tarjetaNumero1' placeholder='Número de la tarjeta'
										value = '".$tarjetaNumero1."'>";?>
										<h4>Fecha de vencimiento:</h4>
										<?php echo "<input type='text' name='tarjetaFecha1' placeholder='Fecha de vencimiento'
										value = '".$tarjetaFecha1."'>";?>
										<h4>CSC:</h4>
										<?php echo "<input type='text' name='tarjetaCSC1' placeholder='Código de seguridad'
										value = '".$tarjetaCSC1."'>";?>
										
									</div>
									<div class='col-sm-4'>		
										<h3>Medio de pago 2:</h4><br>
										
										<h4>Nombre en la tarjeta:</h4>
										<?php echo "<input type='text' name='tarjetaNombre2' placeholder='Nombre en la tarjeta'
										value = '".$tarjetaNombre2."'>";?>
										<h4>Número de tarjeta:</h4>
										<?php echo "<input type='text' name='tarjetaNumero2' placeholder='Número de la tarjeta'
										value = '".$tarjetaNumero2."'>";?>
										<h4>Fecha de vencimiento:</h4>
										<?php echo "<input type='text' name='tarjetaFecha2' placeholder='Fecha de vencimiento'
										value = '".$tarjetaFecha2."'>";?>
										<h4>CSC:</h4>
										<?php echo "<input type='text' name='tarjetaCSC2' placeholder='Código de seguridad'
										value = '".$tarjetaCSC2."'>";?>
									...
									<div class='col-sm-4'>		
										<h3>Medio de pago 3:</h4><br>
										
										<h4>Nombre en la tarjeta:</h4>
										<?php echo "<input type='text' name='tarjetaNombre3' placeholder='Nombre en la tarjeta'
										value = '".$tarjetaNombre3."'>";?>
										<h4>Número de tarjeta:</h4>
										<?php echo "<input type='text' name='tarjetaNumero3' placeholder='Número de la tarjeta'
										value = '".$tarjetaNumero3."'>";?>
										<h4>Fecha de vencimiento:</h4>
										<?php echo "<input type='text' name='tarjetaFecha3' placeholder='Fecha de vencimiento'
										value = '".$tarjetaFecha3."'>";?>
										<h4>CSC:</h4>
										<?php echo "<input type='text' name='tarjetaCSC3' placeholder='Código de seguridad'
										value = '".$tarjetaCSC3."'>";?>
