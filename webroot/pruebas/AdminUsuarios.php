								...
								<div class='tab-content'>
									<?php echo "<div class='tab-pane fade active in' id='datosgenerales".$Identificaciones[$i]."' >"; ?>
										<form id="guardarcambios" target="_blank" action="datosproducto.php" method="post">
											<div class='col-sm-3'>
												...
												<h4>1° apellido:</h4>
												<?php echo "<input type='text' name='nombre' placeholder='Primer apellido' value='".$apellidos1[$i]."'>"; ?>
												<h4>2° apellido:</h4>
												<?php echo "<input type='text' name='nombre' placeholder='Segundo apellido' value='".$apellidos2[$i]."'>"; ?>
												<br><br><br><br>
											</div>
											...
											<div class='col-sm-3'>
												...
												<h4>De la casa:</h4>
												<?php echo "<input type='text' name='nombre' placeholder='Telefono de la casa' value='".$telefonosCasa[$i]."'>"; ?>
												<h4>Del trabajo:</h4>
												<?php echo "<input type='text' name='nombre' placeholder='Telefono del trabajo' value='".$telefonosTrabajo[$i]."'>"; ?>
												<h4>Del celular:</h4>
												<?php echo "<input type='text' name='nombre' placeholder='Telefono del celular' value='".$telefonosCelular[$i]."'>"; ?>
												<h4>Otro:</h4>
												<?php echo "<input type='text' name='nombre' placeholder='Telefono (Otro)' value='".$telefonosOtro[$i]."'>"; ?>
										...
										<div class='col-sm-3'>
											...
											<?php echo "<input type='text' name='nombre' placeholder='Fecha de nacimiento' value='".$fechas[$i]."'>"; ?>
									...
									<?php echo "<div class='tab-pane fade' id='direcciones".$Identificaciones[$i]."' >"; ?>	
										<div class='col-sm-3'>
											...
											<h4>Provincia:</h4>
											<?php echo "<input type='text' name='provincia' placeholder='Provincia' value='".$provinciasCasa[$i]."'>"; ?>
											<h4>Cantón:</h4>
											<?php echo "<input type='text' name='canton' placeholder='Cantón' value='".$cantonesCasa[$i]."'>"; ?>
											<h4>Distrito:</h4>
											<?php echo "<input type='text' name='distrito' placeholder='Distrito' value='".$distritosCasa[$i]."'>"; ?>
										</div>
										<div class='col-sm-3'>
											<h4>-Dirección del trabajo-</h4><br>
												
											<h4>Provincia:</h4>
											<?php echo "<input type='text' name='provincia' placeholder='Provincia' value='".$provinciasTrabajo[$i]."'>"; ?>
											<h4>Cantón:</h4>
											<?php echo "<input type='text' name='canton' placeholder='Cantón' value='".$cantonesTrabajo[$i]."'>"; ?>
											<h4>Distrito:</h4>
											<?php echo "<input type='text' name='distrito' placeholder='Distrito' value='".$distritosTrabajo[$i]."'>"; ?>
										</div>
										<div class='col-sm-3'>
											<h4>-Dirección (Otro)-</h4><br>
												
											<h4>Provincia:</h4>
											<?php echo "<input type='text' name='provincia' placeholder='Provincia' value='".$provinciasOtro[$i]."'>"; ?>
											<h4>Cantón:</h4>
											<?php echo "<input type='text' name='canton' placeholder='Cantón' value='".$cantonesOtro[$i]."'>"; ?>
											<h4>Distrito:</h4>
											<?php echo "<input type='text' name='distrito' placeholder='Distrito' value='".$distritosOtro[$i]."'>"; ?>
										</div>
									</div>
